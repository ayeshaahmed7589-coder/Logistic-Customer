    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        if (responseData["success"] == true) {
          ...
          throw Exception("Quote calculation failed: ${responseData["message"]}");
        }
...
//             "Content-Type": "application/json",
//           },
//           receiveTimeout: Duration(seconds: 60), // ✅ INCREASED TO 60 SECONDS
//           sendTimeout: Duration(seconds: 60), // ✅ INCREASED TO 60 SECONDS
//           // connectTimeout: Duration(seconds: 60), // ✅ ADD CONNECT TIMEOUT
//           validateStatus: (status) {
//             return status! < 500; // ✅ ALLOW 4xx STATUS CODES
//           },
//         ),
//       );
