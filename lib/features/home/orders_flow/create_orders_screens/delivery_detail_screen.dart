...
//         isFilled = true;
//         for (final stop in routeStops) {
//           // Basic validation for all stops
//           bool basicFilled =
//               stop.contactName.text.trim().isNotEmpty &&
//               stop.contactPhone.text.trim().isNotEmpty &&
//               stop.address.text.trim().isNotEmpty &&
...
//           // ✅ Waypoint ke liye quantity/weight required nahi hai
//           if (stop.stopType == StopType.waypoint) {
//             isFilled = isFilled && basicFilled;
//           }
//           // ✅ Pickup ke liye quantity/weight required hai
//           else if (stop.stopType == StopType.pickup) {
//             isFilled =
//                 isFilled &&
//                 basicFilled &&
...
//                 stop.weight.text.trim().isNotEmpty;
//           }
//           // ✅ DropOff ke liye quantity/weight optional hai
//           else if (stop.stopType == StopType.dropOff) {
//             isFilled = isFilled && basicFilled;
//             // DropOff mein quantity/weight optional, isliye check nahi karte
//           }
...
//         // ✅ Waypoint ke liye quantity/weight validation skip
//         if (stop.stopType == StopType.waypoint) {
//           continue;
//         }
...
//         //       SnackBar(
//         //         content: Text(
//         //           "Please enter quantity and weight for ${stop.stopType.displayName} stop",
//         //         ),
//         //         backgroundColor: Colors.red,
//         //       ),
//         //     );
...
//         //   }
//         // }
//         // ✅ DropOff ke liye quantity/weight optional - koi validation nahi
//         else if (stop.stopType == StopType.dropOff) {
//           // Optional - kuch bhi check nahi karte
//           print("DropOff stop - quantity/weight optional");
//         }
//       }
...
//       print("   route_stops_count: ${allCache["route_stops_count"]}");
...
//       // Print each stop's weight
//       for (int i = 1; i <= routeStops.length; i++) {
//         print("   stop_${i}_weight: ${allCache["stop_${i}_weight"]}");
//         print("   stop_${i}_quantity: ${allCache["stop_${i}_quantity"]}");
//       }
//     } else {
...
//       // ✅ Waypoint ke liye quantity/weight save mat karo
//       if (stop.stopType == StopType.waypoint) {
//         cache.saveValue("stop_${stopIndex}_quantity", "");
//         cache.saveValue("stop_${stopIndex}_weight", "");
//         print("✅ Saving Stop $stopIndex (Waypoint) - No quantity/weight");
//       }
//       // ✅ Pickup/DropOff ke liye quantity/weight save karo (DropOff mein empty ho sakta hai)
//       else {
//         cache.saveValue("stop_${stopIndex}_quantity", stop.quantity.text);
//         cache.saveValue("stop_${stopIndex}_weight", stop.weight.text);
//         print(
//           "✅ Saving Stop $stopIndex (${stop.stopType.displayName}) - Weight: ${stop.weight.text}, Quantity: ${stop.quantity.text}",
//         );
//       }
...
//   // Route Stop Card - UPDATED with conditional fields
//   Widget _buildRouteStopCard(RouteStop stop, int index) {
//     return Container(
//       margin: const EdgeInsets.only(bottom: 16),
//       padding: const EdgeInsets.all(16),
...
//           // ✅ CONDITIONAL: Show Quantity & Weight only for Pickup (required) and DropOff (optional)
//           if (stop.stopType != StopType.waypoint) ...[
...
//               // ✅ IMPORTANT: Agar Waypoint select kiya to quantity/weight clear karo
//               if (selectedStopType == StopType.waypoint) {
//                 stop.quantity.clear();
//                 stop.weight.clear();
//               }
